...
public class TyssScrenShot2 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		WebElement logoele = driver.findElement(By.xpath("(//table[@class='textFieldsTable']/descendant::tr[1])[1]"));
		...
		File dsrc=new File("./photo/un.png");
